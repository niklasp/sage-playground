...
export type AjudevDispatchError = Anonymize<Im8avfv272npt>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type AjudevQueries = QueryFromPalletsDef<PalletsTypedef>;
export type AjudevCalls = TxFromPalletsDef<PalletsTypedef>;
export type AjudevEvents = EventsFromPalletsDef<PalletsTypedef>;
export type AjudevErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type AjudevConstants = ConstFromPalletsDef<PalletsTypedef>;
export type AjudevCallData = Anonymize<Iaere0445mg91r> & {
    value: {
        type: string;
    };
};
export type AjudevWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
