...
type IStorage = {
    ...
    CasinoJamTournament: {
         ...
         */
        TournamentSchedules: StorageDescriptor<[Key: number], Anonymize<I9veitme629dgv>, true, never>;
        /**
         ...
         */
        Tournaments: StorageDescriptor<Anonymize<I9jd27rnpm8ttv>, Anonymize<I1sm563u0c9vca>, true, never>;
        /**
         ...
         */
        TournamentRewardClaims: StorageDescriptor<Anonymize<Ielgh4t8o7rcvt>, Anonymize<I6f3f327e3k6hl>, true, never>;
        /**
        
         */
        GoldenDucks: StorageDescriptor<Anonymize<I9jd27rnpm8ttv>, Anonymize<I4m5utiuhsse9r>, false, never>;
        /**
        
         */
        GoldenDuckRewardClaims: StorageDescriptor<Anonymize<I9jd27rnpm8ttv>, Anonymize<I6f3f327e3k6hl>, true, never>;
    };
    CasinoJamSeasons: {
        /**
         ...
         */
        Seasons: StorageDescriptor<[Key: number], Anonymize<I5qohvm4to74le>, true, never>;
        /**
         ...
         */
        SeasonSchedules: StorageDescriptor<[Key: number], Anonymize<I7mjclubiuighb>, true, never>;
        /**
    ...
    CasinoJamSage: {
         ...
         */
        SeasonTradeFilters: StorageDescriptor<[Key: number], Anonymize<Icpgclksujapsm>, true, never>;
        /**
         * A filter that assets need to pass in order to be transfer.
         *
         * The filter can be changed by the organizer.
         */
        SeasonTransferFilters: StorageDescriptor<[Key: number], Anonymize<Icpgclksujapsm>, true, never>;
        /**
         * Tracks assets that have been put on the market with a certain price.
         */
        AssetTradePrices: StorageDescriptor<Anonymize<I9jd27rnpm8ttv>, bigint, true, never>;
        /**
...
export type CasinojamWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
